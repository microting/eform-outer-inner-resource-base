...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormOuterInnerResourceBase/Microting.eFormOuterInnerResourceBase.csproj package Microting.eForm
	dotnet add Microting.eFormOuterInnerResourceBase/Microting.eFormOuterInnerResourceBase.csproj package Microting.eFormApi.BasePn
